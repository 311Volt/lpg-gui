...
lpg::VectorImage::VectorImage(const std::string& path, al::Vec2 scale, al::Color col)
	: al::Bitmap(nullptr)
{
	doc = lunasvg::Document::loadFromFile(path);
	
}
lpg::VectorImage::VectorImage(const std::string& path)
	: VectorImage(path, {1,1}, al::Color::RGBA(0,0,0,0))
{

}

al::Vec2 lpg::VectorImage::getRenderDimensions()
{

}
void lpg::VectorImage::rescale(al::Vec2 newScale)
{

}
void lpg::VectorImage::resize(al::Vec2 newSize)
{

}
void lpg::VectorImage::changeBgColor(al::Color col)
{

}

void lpg::VectorImage::render()
{
